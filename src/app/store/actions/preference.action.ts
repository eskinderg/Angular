...
export const getDarkModeSuccess = createAction('[PREFERENCE] GET_DARK_MODE_SUCCESS', props<{ isDarkMode: boolean }>());
...
export const getIsLoggedInSuccess = createAction('[PREFERENCE] GET_IS_LOGGED_IN_SUCCESS', props<{ isLoggedIn: boolean }>());

export const setIsLoggedIn = createAction('[PREFERENCE] SET_IS_LOGGED_IN', props<{ isLoggedIn: boolean }>());

export const setIsLoggedInSuccess = createAction('[PREFERENCE] SET_IS_LOGGED_IN_SUCCESS', props<{ isLoggedIn: boolean }>());
