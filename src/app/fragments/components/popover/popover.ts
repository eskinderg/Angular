...
export class PopoverWindowComponent {
 ...
 */
@Directive({ selector: '[appPopover]', exportAs: 'appPopover', standalone: true })
export class PopoverDirective implements OnInit, OnDestroy, OnChanges {
    ...
    private _isDisabled(): boolean {
        return this.disablePopover ? true : !this.appPopover && !this.popoverTitle;
    }
