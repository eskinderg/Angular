 ...
 * @since 9.1.0
 */
export interface PaginationPagesContext {
    /**
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'app-template[appPaginationEllipsis]', standalone: true })
export class PaginationEllipsisDirective {
    templateRef = inject(TemplateRef<PaginationLinkContext>);
}
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'app-template[appPaginationFirst]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'app-template[appPaginationLast]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'app-template[appPaginationNext]', standalone: true })
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'app-template[appPaginationNumber]', standalone: true })
export class PaginationNumberDirective {
    templateRef = inject(TemplateRef<PaginationNumberContext>);
}
 ...
 * @since 4.1.0
 */
@Directive({ selector: 'app-template[appPaginationPrevious]', standalone: true })
 ...
 * @since 9.1.0
 */
@Directive({ selector: 'app-template[appPaginationPages]', standalone: true })
export class PaginationPagesDirective {
    templateRef = inject(TemplateRef<PaginationPagesContext>);
}
...
@Component({
    ...
    template: `
        <ng-template #first
            ><span aria-hidden="true" i18n="@@ngb.pagination.first">&laquo;&laquo;</span></ng-template
        >
        <ng-template #previous
            ><span aria-hidden="true" i18n="@@ngb.pagination.previous">&laquo;</span></ng-template
        >
        <ng-template #next><span aria-hidden="true" i18n="@@ngb.pagination.next">&raquo;</span></ng-template>
        <ng-template #last
            ><span aria-hidden="true" i18n="@@ngb.pagination.last">&raquo;&raquo;</span></ng-template
        >
...
export class PaginationComponent implements OnChanges {
    private _config = inject(PaginationConfig);

    pageCount = 0;
    pages: number[] = [];

    @ContentChild(PaginationEllipsisDirective, { static: false }) tplEllipsis?: PaginationEllipsisDirective;
    @ContentChild(PaginationFirstDirective, { static: false }) tplFirst?: PaginationFirstDirective;
    @ContentChild(PaginationLastDirective, { static: false }) tplLast?: PaginationLastDirective;
    @ContentChild(PaginationNextDirective, { static: false }) tplNext?: PaginationNextDirective;
    @ContentChild(PaginationNumberDirective, { static: false }) tplNumber?: PaginationNumberDirective;
    @ContentChild(PaginationPreviousDirective, { static: false }) tplPrevious?: PaginationPreviousDirective;
    @ContentChild(PaginationPagesDirective, { static: false }) tplPages?: PaginationPagesDirective;
