...
export const environment = {
  ...
  Auth: {
    ...
    redirect_uri: 'https://esk-debian:4200/authorize',
    post_logout_redirect_uri: 'https://esk-debian:4200/',
    popup_post_logout_redirect_uri: 'https://esk-debian:4200/',
    response_type: 'code id_token token',
    scope: 'openid email profile api2',
    silent_redirect_uri: 'https://esk-debian:4200/silent-renew.html',
